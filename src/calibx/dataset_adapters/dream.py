...
class Dream:
    ...
    def __init__(
        ...
        *,
        ...
        self.sam3_checkpoint = (
            None if sam3_checkpoint is None else Path(sam3_checkpoint)
        )
        self.resume = resume
    ...
    def _args(self):
        from calibx.runner import parse_args

        argv = [
            "--dataset-dir",
            str(self.data_root),
            "--prerender-dir",
            str(self.prerender_root),
            "--mujoco-xml",
            str(self.mujoco_xml),
            "--output-dir",
            str(self.output_dir),
    ...
    def benchmark(self, model, model_name=None) -> dict:
        ...
        from calibx.runner import process
